 ...
 * @author LN710Q
 */
public class AnimalThreads3 extends Thread{
     private String nombre;
    private int limite,x,y;
    private JLabel animal;

    public AnimalThreads3(){}
    public AnimalThreads3(String nombre,int x, int y, int limite, JLabel animal) {
        this.nombre = nombre;
        this.x = x;
        this.y = y;
        this.limite = limite;
    ...
    @Override
    public void run(){
        for(int i=0; i<this.limite;i+=15){
        ...
        for(int i=this.limite; i>0;i-=15){
